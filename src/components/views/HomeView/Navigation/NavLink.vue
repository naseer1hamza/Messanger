...
<template>
  <div class="xs:mb-0 md:mb-6">
    ...
    >
      ...
      <component
        :is="props.icon"
        class="w-7 h-6 group-focus:text-indigo-400 hover:text-indigo-400 active:text-indigo-400 active:scale-110 dark:text-gray-400 transition ease-out duration-200"
        :class="
